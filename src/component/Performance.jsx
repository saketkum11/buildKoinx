  ...
  return (
    <div className="pb-4">
      ...
      <div className="flex  items-center gap-2  pt-4 text-gray-700">
        <div className="flex flex-col font-bold text-start pr-2">
          <span className="text-xs leading-5 pb-2">Today's Low</span>
          <span className="text-sm leading-6">46,930.22</span>
        </div>
        <div className="relative px-1">
          <div className="h-1 w-36 rounded-lg bg-gradient-to-r from-red-600 via-orange-400 to-green-600 bg-black"></div>
