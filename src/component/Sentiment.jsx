  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="flex gap-2 overflow-x-auto py-4 relative">
          <div className="flex bg-blue-100 py-9 px-4 gap-4 justify-start rounded-lg min-w-96">
            <div className="pt-1">
              <svg
                width="32"
                height="32"
        ...
        <button className="absolute right-2  top-20   ">
          <div className="flex justify-center items-center bg-white w-12 h-12 rounded-full border">
            <svg
              width="6"
              height="11"
              viewBox="0 0 6 11"
      ...
      <div className="flex justify-start items-start gap-4">
        ...
        <div className="flex flex-col ">
          ...
          <div className="flex items-center py-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="h-3 w-8 md:w-8 rounded-sm bg-gray-400"></div>
          ...
          <div className="flex items-center  py-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="h-3 w-10 md:w-16 rounded-sm bg-red-600"></div>
